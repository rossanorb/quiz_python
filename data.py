...
def series():
    return {
        'a': {
            ...
            'msg': 'Você é House of Cards: ataca o problema com método e faz de tudo para resolver a situação.'
        },
        'b': {
            'serie': 'Game of Thrones',
            'msg': 'Você é Game of Thrones: não tem muita delicadeza nas ações, mas resolve o problema de forma prática.'
        },
        'c': {
            'serie': 'Lost',
            'msg': 'Você é Lost: faz as coisas sem ter total certeza se é o caminho certo ou se faz sentido, mas no final dá tudo certo.'
        },
        'd': {
            'serie': 'Breaking Bad',
            'msg': 'Você é Breaking Bad: pra fazer acontecer você toma a liderança, mas sempre contando com seus parceiros.'
        },
        'e': {
            'serie': 'Silicon Valley',
            'msg': 'Você é Silicon Valley: vive a tecnologia o tempo todo e faz disso um mantra para cada situação no dia.'
        }
    }
...
def questions():
    return {
            ...
            2: {
                'title': 'Indo para o trabalho você encontra uma senhora idosa caída na rua',
                'questions': {
            ...
            3: {
                'title': 'Chega no prédio e o elevador está cheio',
                'questions': {
            ...
            4: {
                'title': 'Você chega no trabalho e as convenções sociais te obrigam a puxar assunto',
                'questions': {
            ...
            5: {
                'title': 'A pauta pegou o dia todo, mas você está indo para casa',
                'questions': {
